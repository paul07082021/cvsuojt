...
<div class='row'>
    ...
    <div class='panel-heading'>Edit Footer</div>
    <div class='panel-body'>

        <form method='post' action='{{CRUDBooster::mainpath('edit-save/'.$row->id)}}'>
            <div class='form-group'>
                <label>Footer Title</label>
                <input type='text' name='footer_title' required class='form-control' value='<?= $row->footer_title; ?>'/>
                <input type='hidden' class="txt-save-html" name='footer_content' required class='form-control' value=''/>
                <input type='hidden' class="txt-save-css" name='footer_css' required class='form-control' value=''/>
                
               <label>Footer status</label>
                        <select style="width:100%" class="form-control select2-hidden-accessible" id="footer_status_id" name="footer_status_id" tabindex="-1" aria-hidden="true">
                            <?php
                            if ($row->footer_status_id == 2) {
...
var comphtml = '<?= $row->footer_content; ?>';
var compcss = '<?= $row->footer_css; ?> ';
