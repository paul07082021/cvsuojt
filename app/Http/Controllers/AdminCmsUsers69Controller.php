<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers69Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Acct Status","name"=>"acct_status","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Image Reference","name"=>"image_reference","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Input Referal","name"=>"input_referal","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Lastname","name"=>"lastname","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"My Referal","name"=>"my_referal","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Reference Number","name"=>"reference_number","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
	              $query->where('acct_status', 'Verified')->where('id_cms_privileges', '3');
	    }
