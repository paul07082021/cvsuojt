<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers72Controller extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "dashboard";
			$this->limit = "20";
	    ...
	    */
        ...
        $data = [];
        $data['result'] = DB::table('cms_users')->where('id', $myid)->get();
        $data['myid'] = CRUDBooster::myId();
        $this->cbView('user-dashboard',$data);
