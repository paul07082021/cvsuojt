...
$apkLogsSegment = end($urlSegments);



if($apkLogsSegment == "apk_logs" || $apkLogsSegment == "deposit_tb" ){
    echo '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#export-data">
    Export
  </button>';
}
?>
