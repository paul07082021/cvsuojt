...
<header class="main-header" >
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo" style="background-color:#32a852; color:white;">{{CRUDBooster::getSetting('appname')}}</a>

    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color:#32a852;">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu" >
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title='Notifications' aria-expanded="false">
                        ...
                        <span id='notification_count' class="label label-danger" style="display:none"></span>
                    </a>

                  
                    <ul class="dropdown-menu">

                    <div id="refreshedNotif"></div>
