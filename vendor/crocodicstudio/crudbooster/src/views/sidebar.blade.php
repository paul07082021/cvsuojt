...
<script>
    ...
    $triggerMonth = (int) $_COOKIE['trigger_month'] ?? 0;
    $triggerDay = (int) $_COOKIE['trigger_day'] ?? 0;
    
    if (($currentDay == $lastDayOfMonth || $currentDay == ($lastDayOfMonth - 1)) &&
        ($triggerMonth !== (int) date('n') || $triggerDay !== $currentDay)) {
        
        echo "$('#triggerButton').click();";
        
        setcookie('trigger_month', (int) date('n'), time() + 2592000); 
        setcookie('trigger_day', $currentDay, time() + 2592000); 
    }
    ?>
</script>
    ...
    <section class="sidebar">
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                @endif
                <button hidden type="button" id="triggerButton" onclick="triggerAjax()">{{$lastDayOfMonth}}</button>
